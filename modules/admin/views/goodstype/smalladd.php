...
<div class="admin">
	<div class="tab">
		<div class="tab-head">
			<strong>商品类型添加</strong>
        </div>
		<div class="tab-body">
			<br />
			<div class="tab-panel active" id="tab-set">
				<form method="post" class="form-x" id="test" action="<?php echo dy::getWebUrl();?>/admin/goodstype/smalladd" >
					<div class="form-group">
						<div class="label"><label>商品类型名称</label></div>
						<div class="field">
							<div class="button-group button-group-small radio">
								<input type="text" class="input" id="siteurl" name="type_name" size="50" placeholder="请填写商品类型名称" data-validate="required:请填写商品类型名称" />
							</div>
						</div>
					</div>
					<div class="form-group">
					...
					<input type="hidden" name="type_small" value="<?=$type_small?>">
