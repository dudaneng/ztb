	...
	<div class="tab">
		...
		<div class="tab-body">
			...
			<div class="tab-panel active" id="tab-set">
				<form method="post" class="form-x" id="test" action="<?php echo dy::getWebUrl();?>/admin/area/addrest" >
					<div class="form-group">
						<div class="label"><label>自提地址</label></div>
						<div class="field">
							<div class="button-group button-group-small radio">
								<input type="text" class="input" id="siteurl" name="address" size="50" placeholder="请填写自提地址" data-validate="required:请填写自提地址" />
							</div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="field">
							...
							<select name="area_small" id="set_areamid">
								<option value="0">--请选择--</option>
							</select>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="button-group button-group-small radio">
							<input type="text" min="0" class="input" id="sitename" name="shop_time" size="50" placeholder="请填写营业时间"/>
						</div>
					</div>
					<div class="form-group">
						<div class="label"><label>联系电话</label></div>
						<div class="button-group button-group-small radio">
							<input type="text" min="0" class="input" id="sitename" name="contact" size="50" placeholder="请填写联系电话"/>
						</div>
					</div>
					<div class="form-group">
